# CS 1632 Midterm 1 Exam Study Guide - Spring 2026

The midterm is going to be **open book** but **individual work**.  Only printed
or written material in physical form will be allowed during the exam and the
use of electronic devices to browse the web, use AI, or peruse electronic
...
* Be able to define all terminology introduced or fill in the blank.
* **Be able to write a test case with precise preconditions / execution steps / postconditions, given a testing scenario.**
