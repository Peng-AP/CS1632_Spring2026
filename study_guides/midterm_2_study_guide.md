# CS 1632 Midterm 2 Exam Study Guide - Spring 2026
...
If you want more QuickCheck and Java Path Finder coding practice, look inside
the [midterm_2_practice](midterm_2_practice) folder.  There are some model checking related questions in there as well.  If you want more Google Sanitizer practice, look inside [midterm_2_sanitizer](midterm_2_sanitizer).
